  ...
  <v-sheet>
    ...
    <v-table>
      ...
      <tr>
        ...
        <th scope="col" class="right">{{ $t('forum.tag.nbTopic') }}</th>
        <th scope="col" class="right">{{ $t('forum.tag.nbMessage') }}</th>
      ...
      <tr v-for="forum in forums" :data-position="forum.position" :key="forum.id">
        ...
        <td style="width:100px" class="right">{{ number(forum.nbTopic) }}</td>
        <td style="width:100px" class="right">{{ number(forum.nbMessage) }}</td>
        <td style="width:300px" class="hidden-sm-and-down">
